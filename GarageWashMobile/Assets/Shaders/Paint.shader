Shader "Custom/Paint"
{
    ...
    SubShader
    {
        Tags
        {
            "RenderType" = "Transparent" "Queue" = "Transparent" "RenderPipeline" = "UniversalPipeline" "UniversalMaterialType" = "Unlit"
        }
        ...
        Pass
        {
            ...
            float4 frag(Varyings i) : SV_Target0
            {
                ...
                // --- ¡LÍNEA CAMBIADA! ---
                // El alpha final ahora es una combinación de la forma del pincel Y la fuerza (alpha) del color que pasamos.
                return float4(_PaintColor.rgb, _PaintColor.a * positionStrength * facingStrength);
            }
